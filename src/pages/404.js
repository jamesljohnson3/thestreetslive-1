    ...
    return(
        ...
        <section>
            <div className="min-h-screen px-4 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
              ...
              <img src="/now.png" alt="Ghost" height="64" width="64" className="text-center mx-auto transform scale-110 animate-pulse	"/>
              <h2 className="text-5xl max-w-xl mx-auto mt-8 text-left lg:text-center font-spooky animate-pulse">404 n</h2>
